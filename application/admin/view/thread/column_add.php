                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body ">
                        <div class="layui-container">
                            ...
                            <div class="layui-form-item vip_group" style="display: none">
                            ...
                            <div class="layui-form-item points_group" style="display: none">
                                <label class="layui-form-label">积分限制</label>
                                <div class="layui-input-inline">
                                    <input type="text"  class="layui-input" name="points_limit" value="" />
                                </div><div class="check-tips"></div>
                            </div>
